...
class Player{
    ...
    update(){
        ...
        let dx = this.x - mouse.x - this.width / 2;
        let dy = this.y - mouse.y - this.height / 2;
...
document.body.addEventListener("touchmove", function (e) { //allows mobile users to touch drag the player sprite
